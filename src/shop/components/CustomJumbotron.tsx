...
export const CustomJumbotron = ({ title, subTitle }: Props) => {
  const defualtSubTitle =
    "Ropa minimalista y elegante inspirada en el diseño futurista de Tesla. Calidad premium para un estilo de vida moderno.";
