...
export const ProductForm = ({
  ...
  const selectedSizes = watch("sizes"); // Se ejecuta cada vez que el valor de sizes cambia
  ...
  const removeSize = (size: Size) => {
    const sizeSet = new Set(getValues("sizes"));
    sizeSet.delete(size); // Eliminar la talla del set.
    setValue("sizes", Array.from(sizeSet));
  };
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                        {
                          "border-red-500 border-2": errors.price,
                        }
                      )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                        {
                          "border-red-500 border-2": errors.stock,
                        }
                      )}
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register("slug", {
                      ...
                      validate: (value) =>
                        !/\s/.test(value) ||
                        "El slug no puede contener espacios en blanco", // Si hay algún espacio
                    })}
                    className={cn(
                      "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                      {
                        "border-red-500 border-2": errors.slug,
                      }
                    )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={cn(
                      "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                      {
                        "border-red-500 border-2": errors.description,
                      }
                    )}
                  ...
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " " || e.key === ",") {
                        e.preventDefault(); // Para no postear el formulario
                        addTag();
                        newTagRef.current!.value = ""; // Resetear el input
                      }
                    }}
